...
namespace Assign14.Controllers
{
    public class PlayersController : Controller
    {
        ...
        public ActionResult Edit(int id, Player player)
        {
            ...
            {
                con = new SqlConnection(conString);
                cmd = new SqlCommand("update Players set FirstName = @fn, LastName = @ln, JerseyNumber = @jn, Position = @pos, Team = @team where PlayerId = @pid", con);
        ...
        public ActionResult Delete(int id, Player player)
        {
            ...
            {
                con = new SqlConnection(conString);
                cmd = new SqlCommand("delete from Players where PlayerId = @id", con);
